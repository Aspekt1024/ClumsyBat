...
public static class BossEditorContextMenus{
	...
	public static void ShowMenu(GenericMenu.MenuFunction2 callbackFunc)
    {
        ...
        menu.AddItem(new GUIContent("Add Wait Node"), false, callbackFunc, NodeTypes.Wait);
        ...
        menu.AddItem(new GUIContent("Add Loop Node"), false, callbackFunc, NodeTypes.Loop);
        menu.ShowAsContext();
    }
