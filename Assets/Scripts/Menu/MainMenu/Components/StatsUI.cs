...
public class StatsUI : MonoBehaviour
{
    ...
    private void Update()
    {
        if (_idleTimeTxt)
        {
            _idleTimeTxt.GetComponent<Text>().text = GetValStr((int)GameStatics.Data.Stats.IdleTime, "s");
        }
    }
    ...
    private void InitialiseStatsList()
    {
        ...
        NewStat("Total Distance", (int)stats.TotalDistance, "m");
        NewStat("Currency", stats.Currency, "");
        NewStat("TotalCurrency", stats.TotalCurrency, "");
        NewStat("Levels Completed", stats.LevelsCompleted, "");
        NewStat("Most Moths Eaten", stats.MostMoths, "");
        NewStat("Total Moths Eaten", stats.TotalMoths, "");
        NewStat("Total Deaths", stats.Deaths, "");
        NewStat("Deaths to Rocks", stats.RockDeaths, "");
        NewStat("Death to Stalactites", stats.ToothDeaths, "");
        NewStat("Total times Jumped", stats.TotalJumps, "");
        NewStat("Times Dash Used", stats.TimesDashed, "");
